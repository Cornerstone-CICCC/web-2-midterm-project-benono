...
import { fetchTVById } from '@/app/lib/tmdb/api'
...
export default async function Page({
  ...
  const tv = await fetchTVById(params.id)
  const mainCast = getMainCast(tv.credits)
  const directorAndWriter = getDirectorAndWriter(tv.credits)
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="flex flex-col md:flex-row md:space-x-8 mb-8 md:mb-0">
          ...
          <div className="w-full md:w-2/3">
            ...
            <p className="text-gray-600 mb-4">{tv.first_air_date}</p>
            ...
            <p className="text-foreground mb-6">{tv.overview}</p>
